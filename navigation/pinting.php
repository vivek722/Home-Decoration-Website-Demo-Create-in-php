...
$s = 'SELECT * FROM `add_product` WHERE pcategory = "printing"';
...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Decorated Painting</h1></h1>
...
<form method="post" action="cart.php?action=add&pid=<?php echo $row["id"]; ?>">
    ...
    <div class="container"style="background-color:black ;">
      ...
      <div class="col-md-4 mb-4">
            ...
            <div class="card-body">
            <p class="card-text">pinting Name :- <?php echo $row['product_name'] ?></p>
