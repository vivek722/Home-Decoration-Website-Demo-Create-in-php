...
<main style=" background-image:url('../img/3.jpeg')"; >
  <div class="container py-4" >
    <header class="pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none">
        ...
        <span class="fs-4"><h1 style="font-style:italic ;" ><b>   About us </b></h1></span>
      </a>
    </header>

    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold"  style="font-style:italic ;" >Information About Our Product and Organization </h1>
    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-6">
        <div class="h-100 p-5 text-bg-dark rounded-3">
          <h2>Details About Our Product</h2>
      ...
      <div class="col-md-6">
        <div class="h-100 p-5 text-bg-dark rounded-3">
          <h2>Details About Our Product Delivery</h2>
